// using System;
// using UnityEngine;
// using IMoveController = MatchThree.IMoveController;
...
//         [SerializeField] MoveConfig _moveConfig = new MoveConfig();
//
//         public MoveControllerLayoutWraper Master
//         {
//             get => layoutWraper;
//             set => layoutWraper = value;
//         }
//
//         public int Index
//         {
...
//         {
//             // Debug.Log($"[{gameObject.name}]start following target");
...
//             if (IsAtDestination)
//             {
//                 // Debug.Log("at destination already");
//                 onFinish?.Invoke();
//                 return;
//             }
//             follow = true;
...
//             {
//                 Debug.LogError("Canot match rect size, layout follower only work on ui element with rect transform atttached");
//             }
