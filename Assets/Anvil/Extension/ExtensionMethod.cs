...
namespace Anvil
{
    public static partial class ExtensionMethod
    {
        ...
        {
            if (MonoBehaviourMessageForwarder.CommonMessageInstance == null)
            {
                action?.Invoke();
            ...
            MonoBehaviourMessageForwarder.CommonMessageForwarder.StartCoroutine(coRoutine());
        ...
        {
            if (MonoBehaviourMessageForwarder.CommonMessageForwarder == null)
            {
                action?.Invoke();
                return;
            }
