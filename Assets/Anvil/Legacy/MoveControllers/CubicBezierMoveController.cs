...
{
    public class CubicBezierMoveController : LerpMoveController
    {
        CubicBezierConfig2D _config2D;
        Vector3 _controlPos;
        Vector3 _control2Pos;

        public CubicBezierConfig2D Config2D
        {
            get => _config2D;
            set => _config2D = value;
        }
        ...
        public override void MoveTo(Vector3 endPos, Action callback = null)
        {
            ...
            if (_config2D != null)
            {
                _config2D.GetControlsPosition(Current, endPos, out controlPos, out control2Pos);
            }
            else
            {
        ...
        public override void UpdateConfig(MoveConfig moveConfig)
        {
            ...
            Config2D = moveConfig.CubicBezierConfig2D;
        }
