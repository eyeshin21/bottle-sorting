...
namespace Anvil.Legacy
{
    public static partial class JsonHelper
    {
        ...
        /// <summary>
        /// Returns "row1_column1_..."
        /// </summary>
        public static string SerializeValues(List<CellPoint> points, char separator = ValueSeparator)
        {
            return Serialize(list =>
            {
                ...
                {
                    points[i].Get(out int row, out int column);
                    list.Add(row);
                    list.Add(column);
                }
            }, separator);
        ...
        public static void DeserializeValues(string json, ref List<CellPoint> points, char separator = ValueSeparator)
        {
            Deserialize(json, ref points, separator);
        }

        public static void Deserialize(string json, ref List<CellPoint> points, char separator = ItemSeparator)
        {
            var list = GetIntList();
            Deserialize(json, ref list, separator);
            ...
            if (count > 0)
            {
                ...
                {
                    points.Add(new CellPoint(list[i], list[i + 1]));
                }
