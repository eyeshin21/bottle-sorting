...
namespace _AppsFlyerSDK
{
    ...
    public static class AppsFlyer
    {
        ...
        public static void logAdRevenue(AFAdRevenueData afAdRevenueData, Dictionary<string, string> additionalParameters)
        {

        }
    }

    public static class AppsFlyerAdRevenue
    {
    ...
    {
        public AFAdRevenueData(string adNetwork, MediationNetwork mediationNetwork, string currency, double revenue)
        {
