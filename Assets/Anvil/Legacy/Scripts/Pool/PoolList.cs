...
namespace Anvil.Legacy
{
    ...
    class LinkedList<T> where T : new()
    {
        ...
        /// func(node, remove)
        /// </summary>
        public void ForEach(Func<T, bool> func, LinkedPool<T> pool)
        {
    ...
    {
        public Callback<T> ReturnCallback { get; set; }
    ...
    public class PoolList<T> where T : new()
    {
        ...
        /// <summary>
        /// Adding list and current list.
        /// </summary>
        public void ForEach(Callback<T> callback)
        {
            _addList.ForEach(callback);
