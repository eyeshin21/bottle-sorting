...
namespace Anvil
{
    ...
    {
        [SerializeField] protected bool _playOnEnable = false;
        // [SerializeField] protected bool _keepVolume
        ...
        public virtual void Play(float timeStamp, Action callback = null)
        {
            Stop();
            StartAudioSource(callback, timeStamp);
        }

        protected virtual void StartAudioSource(Action callback, float timeStamp = 0)
        {
            _audioSource.Play();
