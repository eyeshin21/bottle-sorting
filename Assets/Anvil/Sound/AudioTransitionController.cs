...
namespace Anvil
{
    ...
    public class AudioTransitionController
    {
        ...
        protected virtual void OnExitTransitionStart()
        {
            ...
            OnEntryTransitionStart(timeStamp);

        }

        protected virtual void OnEntryTransitionStart(float exitTimeStamp = 0)
        {
            ...
            if (_exitPlayer is SequentialAudioPlayer sequentialExit
                && _entryplayer is SequentialAudioPlayer sequentialEntry)
            {
                sequentialEntry._currentClipIndex = sequentialExit._currentClipIndex-1;
            }
            _entryplayer.Play(exitTimeStamp);
